# Tang Console 138K C-revision carrier pin reference
...
| USER / RESET buttons | `AB13`, `AA13` | active-low; **Console 138K uses `LVCMOS33`, bank 3.3 V** |
...
The v3.1 board package selects current `GW5AST-138C` silicon; an older B-marked
SOM must use a B-revision Gowin EDA project instead.
