...
## v3.2.1 — automatically synchronized

- Packaged and tested the v3.2.1 Studio release from its immutable Git tag.
...
## v3.2.0 — automatically synchronized

- Packaged and tested the v3.2.0 Studio release from its immutable Git tag.
- Updated the bundled IDE, examples, documentation, and screenshots.
- Published a checksum and signed GitHub build-provenance attestation.

## v3.1.1 — automatically synchronized

- Packaged and tested the v3.1.1 Studio release from its immutable Git tag.
- Updated the bundled IDE, examples, documentation, and screenshots.
- Published a checksum and signed GitHub build-provenance attestation.

## v3.1.0 — automatically synchronized

- Packaged and tested the v3.1.0 Studio release from its immutable Git tag.
- Updated the bundled IDE, examples, documentation, and screenshots.
- Published a checksum and signed GitHub build-provenance attestation.

## v3.0.0 — automatically synchronized

- Packaged and tested the v3.0.0 Studio release from its immutable Git tag.
- Updated the bundled IDE, examples, documentation, and screenshots.
- Published a checksum and signed GitHub build-provenance attestation.
...
- Packaged Python and Tkinter so customers do not install Python separately.
- Added a generated multi-resolution application and Desktop icon.
- Added automatic user-workspace creation under Documents.
- Added pinned OSS CAD Suite and Zadig verification during setup.
- Added dark/light packaged UI smoke tests and installed-layout validation.
- Added GitHub/Sigstore build-provenance attestations and release checksums.
